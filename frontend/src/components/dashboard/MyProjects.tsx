...
const MyProjects = ({ user }: MyProjectsProps) => {
    ...
    if (isError) {
        console.error("Error while getting user's projects", error)
    }
        ...
        <div className="flex flex-col">
            ...
            <div className='flex py-6'>
                <StateDisplay 
                    isLoading={isLoading}
                    isError={isError}
                    errorMsg='Error occurred while getting your projects.'
                    isEmpty={filteredProjects.length == 0}
                    emptyMsg='You have not created any projects or have no projects with this status.'
                >
